...
　　本篇文章累计了大量评论，和我的一些解答，读者有什么问题可以先看看评论，或者搜下关键字，如果还是有问题可以给我在评论里给我留言，问题很着急的可以加我 ＱＱ：78233332　，或者给我发邮件：[hello_sorrow@163.com](mailto:hello_sorrow@163.com)  ，都可以，如果你已经搭建完成了，可以看看另一篇博客[HEXO进阶](http://baixin.io/2016/06/HEXO_Advanced/)，有讲如何能百度搜索你的博客、多台电脑使用HEXO发布博客等。
...
[github](https://github.com/)账号我也不再啰嗦了,没有的话直接申请就行了，跟一般的注册账号差不多，SSH Keys，看你自己了，可以不配制，不配置的话以后每次对自己的博客有改动提交的时候就要手动输入账号密码，配置了就不需要了，怎么配置我的简书上[小神猫的简书](http://www.jianshu.com/p/765d6d04b11f),是在MAC上配置的。
...
deploy:
type: git
repository: https://github.com/xiaoshenmao/xiaoshenmao.github.io.git
branch: master
...
　然后再浏览器中输入[http://xiaoshenmao.github.io/](http://xiaoshenmao.github.io/)就行了，我的 github 的账户叫 xiaoshenmao ,把这个改成你 github 的账户名就行了
...
转载请注明原地址，向宇辉的博客：[http://xiaoshenmao.github.io](http://xiaoshenmao.github.io) 谢谢！
